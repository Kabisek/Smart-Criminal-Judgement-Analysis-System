    ...
    async def predict_appeal_outcome(self, case_description: str) -> Dict[str, Any]:
        ...
        try:
            ...
            response = {
                ...
                'confidence_raw_max': prediction_result.get('confidence_raw_max'),
                'probability_margin_points': prediction_result.get('probability_margin_points'),
                'probabilities': prediction_result['probabilities'],
                'probabilities_model_raw': prediction_result.get('probabilities_model_raw'),
                'inference_calibration_notes': prediction_result.get('inference_calibration_notes', []),
